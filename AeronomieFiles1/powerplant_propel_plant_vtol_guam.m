...
%% Geometry & Mass
powerplant.propel.plant.init.rotorcorediam = 0.30;      % m     % Hub diameter (approx 30cm)
powerplant.propel.plant.init.Wprop = 20.0;              % N     % Propeller weight (approx 2kg)
powerplant.propel.plant.init.Iprop = 0.025;             % kgm^2 % Propeller Inertia (Bulk of the 0.028 total)
powerplant.propel.plant.init.propD = 1.68;              % m     % Diameter (5.5 ft)
...
%% Performance Limits
powerplant.propel.plant.init.Pmax = 90000;              % W     % Max Power (90 kW)
...
powerplant.propel.ctrl.init.trq_trim = 628.0;   % N-m   % Torque required to hover
